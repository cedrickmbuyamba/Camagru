...
$source = imagecreatefrompng($img); // The Logo is the source
...
$destination = imagecreatefrompng($monatageDir . $uiid . ".png"); // The photo is the destination
...
if (strcmp($img, "../img/cigarette.png") == 0) {
  $destination_x = 100;
  $destination_y = 200;
} else if (strcmp($img, "../img/images.png") == 0) {
  $destination_x = 180;
  $destination_y = 0;
} else {
  $destination_x = 0;
